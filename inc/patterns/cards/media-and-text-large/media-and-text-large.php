<!-- wp:group {"align":"wide","className":"alignwide card-columns__two ","metadata":{"name":"Cards Image + Text Large"}} -->
<div class="wp-block-group alignwide card-columns__two">
	...
	<!-- wp:media-text {"align":"wide","mediaId":1542,"mediaLink":"https://apsc-brand.sites.olt.ubc.ca/guidelines/graphic-devices/engineering-graphic-device-gradient/","mediaType":"image","className":"card"} -->
	<div class="wp-block-media-text alignwide is-stacked-on-mobile card">
		<figure class="wp-block-media-text__media">
		...
		<div class="wp-block-media-text__content">
			...
			<!-- wp:paragraph -->
			<p>This card has some paragraph text description. Is it something to do with the extra text?</p>
			<!-- /wp:paragraph -->
		</div>
	</div>
	<!-- /wp:media-text -->
	...
	<!-- wp:media-text {"align":"wide","mediaId":1534,"mediaLink":"https://apsc-brand.sites.olt.ubc.ca/sala-graphic-device-gradient/","mediaType":"image","isStackedOnMobile":false,"className":"card"} -->
	<div class="wp-block-media-text alignwide card">
		<figure class="wp-block-media-text__media">
			<a href="https://apsc.share.ubc.ca/servicesresources/communications/BrandDownloads/Forms/SALA.aspx">
				<img src="https://apsc-brand.sites.olt.ubc.ca/files/2020/09/SALA-graphic-device-gradient.png" alt="SALA graphic device over gradient" class="wp-image-1534 size-full"/>
			</a>
		</figure>
		<div class="wp-block-media-text__content">
			<!-- wp:heading {"level":3} -->
	...
	<!-- wp:media-text {"align":"wide","mediaId":1536,"mediaLink":"https://apsc-brand.sites.olt.ubc.ca/guidelines/graphic-devices/scarp-graphic-device-gradient/","mediaType":"image","isStackedOnMobile":false,"className":"card"} -->
	<div class="wp-block-media-text alignwide card">
		<figure class="wp-block-media-text__media">
			<a href="https://apsc.share.ubc.ca/servicesresources/communications/BrandDownloads/Forms/SCARP.aspx">
				<img src="https://apsc-brand.sites.olt.ubc.ca/files/2020/09/SCARP-graphic-device-gradient.png" alt="SCARP graphic device over gradient" class="wp-image-1536 size-full"/>
			</a>
		</figure>
		<div class="wp-block-media-text__content">
			<!-- wp:heading {"level":3} -->
			<h3 class="wp-block-heading">SCARP</h3>
			<!-- /wp:heading -->
		</div>
	</div>
	<!-- /wp:media-text -->
